...
@Autowired
public EntreeStockAdminService entreeStockAdminService;
    @Bean
    ...
    return (args) -> {
        ...
        if(true){
       BigDecimal total=entreeStockAdminService.getChangeTotalForYear(2026);
            System.out.println("total = " + total);
            BigDecimal total2=entreeStockAdminService.getChangeTotalForYear(2025);
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        ...
        modelPermissions.add(new ModelPermission("EntreeStockDetail"));
        modelPermissions.add(new ModelPermission("EntreeStock"));
        modelPermissions.add(new ModelPermission("Fournisseur"));
        modelPermissions.add(new ModelPermission("SortieStock"));
        modelPermissions.add(new ModelPermission("SortieStockDetail"));
