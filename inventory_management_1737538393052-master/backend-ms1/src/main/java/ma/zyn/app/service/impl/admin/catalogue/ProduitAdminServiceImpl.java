...
import ma.zyn.app.dao.facade.core.catalogue.ProduitDao;
import ma.zyn.app.dao.specification.core.catalogue.ProduitSpecification;
...
public class ProduitAdminServiceImpl implements ProduitAdminService {
    ...
    public long countByCategorieProduitCode(String code){
        return dao.countByCategorieProduitCode(code);
    }
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, readOnly = false)
