package ma.zyn.app.unit.dao.facade.core.catalogue;
...
@Autowired
    ...
    void shouldFindByCode(){
        ...
        CategorieProduit loaded = underTest.findByCode(code);
    ...
    void shouldFindById(){
        ...
        entity.setId(id);
        underTest.save(entity);
        CategorieProduit loaded = underTest.findById(id).orElse(null);
