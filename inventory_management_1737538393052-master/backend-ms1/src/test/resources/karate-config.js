function fn() {
    ...
    config.entreeStockDetailUrl = config.adminUri + 'entreeStockDetail/';
    config.entreeStockUrl = config.adminUri + 'entreeStock/';
    config.fournisseurUrl = config.adminUri + 'fournisseur/';
    config.sortieStockUrl = config.adminUri + 'sortieStock/';
    config.sortieStockDetailUrl = config.adminUri + 'sortieStockDetail/';
