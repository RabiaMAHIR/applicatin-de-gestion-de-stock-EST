...
export class StockAdminService {
    ...
    public getStocksByMagazinId(labelMagazin: string): Observable<StockDto[]> {
        return this.http.get<StockDto[]>(this.API + 'magazin/' + labelMagazin);
    }
    
    public getTotalQuantitiesForAllProduits(): Observable<Map<string, number>[]> {
        return this.http.get<Map<string, number>[]>(this.API + 'produits/total-quantities');
    }
    ...
    get API() {
        return environment.apiUrlInventorymanagementms1 + 'admin/stock/';
    }
