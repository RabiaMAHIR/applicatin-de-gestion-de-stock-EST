...
@Component({
  selector: 'app-entree-stock-list-admin',
  templateUrl: './entree-stock-list-admin.component.html'
})
export class EntreeStockListAdminComponent implements OnInit {
    ...
    public exportPdf(dto: EntreeStockDetailDto): void {
        this.entreeStockDetailService.exportPdf(dto).subscribe((data: ArrayBuffer) => {
