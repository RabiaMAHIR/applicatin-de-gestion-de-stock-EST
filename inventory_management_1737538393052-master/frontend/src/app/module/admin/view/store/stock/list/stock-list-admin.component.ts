...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'produit?.label', header: 'Produit'},
            {field: 'magazin?.label', header: 'Magazin'},
    ...
    public async loadMagazin(){
        this.magasinService.findAllOptimized().subscribe(magazins => this.magazins = magazins, error => console.log(error))
    }
        ...
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						'Produit': e.produit?.label ,
						'Magazin': e.magazin?.label ,
						'Quantite': e.quantite ,
            ...
            this.criteriaData = [{
            //'Produit': this.criteria.produit?.label ? this.criteria.produit?.label : environment.emptyForExport ,
            //'Magazin': this.criteria.magazin?.label ? this.criteria.magazin?.label : environment.emptyForExport ,
