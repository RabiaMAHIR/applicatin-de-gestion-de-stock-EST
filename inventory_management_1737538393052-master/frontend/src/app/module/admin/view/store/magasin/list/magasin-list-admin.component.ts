...
export class MagasinListAdminComponent implements OnInit {

    protected fileName = 'Magasin';
    ...
    constructor( private service: MagasinAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MagasinDto>();
    ...
    public async edit(dto: MagasinDto) {
    ...
    public async view(dto: MagasinDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MagasinDto) {
    ...
    public async duplicate(dto: MagasinDto) {
    ...
    public exportPdf(dto: MagasinDto): void {
...
// add
    ...
    get items(): Array<MagasinDto> {
        return this.service.items;
    }

    set items(value: Array<MagasinDto>) {
        this.service.items = value;
    }

    get selections(): Array<MagasinDto> {
        return this.service.selections;
    }

    set selections(value: Array<MagasinDto>) {
    ...
    get criteria(): MagasinCriteria {
        return this.service.criteria;
    }

    set criteria(value: MagasinCriteria) {
