...
export class MagasinCreateAdminComponent  implements OnInit {
   ...
   private _validMagasinLabel = true;
    ...
    get validMagasinLabel(): boolean {
        return this._validMagasinLabel;
    }

    set validMagasinLabel(value: boolean) {
         this._validMagasinLabel = value;
    }
