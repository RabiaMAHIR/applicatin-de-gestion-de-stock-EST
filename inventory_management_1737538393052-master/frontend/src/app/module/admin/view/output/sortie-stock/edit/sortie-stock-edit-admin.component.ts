...
@Component({
  selector: 'app-sortie-stock-edit-admin',
  templateUrl: './sortie-stock-edit-admin.component.html'
})
export class SortieStockEditAdminComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateSortie = this.service.format(this.item.dateSortie);
    }
 ...
 public edit(): void {
    ...
    public validateSortieStockDetails(){
