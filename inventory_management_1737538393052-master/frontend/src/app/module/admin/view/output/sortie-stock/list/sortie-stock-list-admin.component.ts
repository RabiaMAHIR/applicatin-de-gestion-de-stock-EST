...
@Component({
  selector: 'app-sortie-stock-list-admin',
  templateUrl: './sortie-stock-list-admin.component.html'
})
export class SortieStockListAdminComponent implements OnInit {

    protected fileName = 'SortieStock';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SortieStockDto>();
    ...
    public async edit(dto: SortieStockDto) {
    ...
    public async view(dto: SortieStockDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SortieStockDto) {
    ...
    public async duplicate(dto: SortieStockDto) {
    ...
    public exportPdf(dto: SortieStockDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'dateSortie', header: 'Date sortie'},
	...
	public initDuplicate(res: SortieStockDto) {
        if (res.sortieStockDetails != null) {
             res.sortieStockDetails.forEach(d => { d.sortieStock = null; d.id = null; });
        }
	}
        ...
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						'Date sortie': this.datePipe.transform(e.dateSortie , 'dd/MM/yyyy hh:mm'),
            ...
            this.criteriaData = [{
                'Date sortie Min': this.criteria.dateSortieFrom ? this.datePipe.transform(this.criteria.dateSortieFrom , this.dateFormat) : environment.emptyForExport ,
                'Date sortie Max': this.criteria.dateSortieTo ? this.datePipe.transform(this.criteria.dateSortieTo , this.dateFormat) : environment.emptyForExport ,
    ...
    get selections(): Array<SortieStockDto> {
        return this.service.selections;
    }

    set selections(value: Array<SortieStockDto>) {
