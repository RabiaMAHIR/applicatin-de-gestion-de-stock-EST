...
import {CategorieProduitCriteria} from 'src/app/shared/criteria/catalogue/CategorieProduitCriteria.model';
...
export class CategorieProduitListAdminComponent implements OnInit {
    ...
    constructor( private service: CategorieProduitAdminService  , @Inject(PLATFORM_ID) private platformId?) {
