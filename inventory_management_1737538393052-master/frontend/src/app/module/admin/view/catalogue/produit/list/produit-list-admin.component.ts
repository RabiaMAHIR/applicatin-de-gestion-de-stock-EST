...
export class ProduitListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProduitDto>();
    ...
    public async edit(dto: ProduitDto) {
    ...
    public async view(dto: ProduitDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProduitDto) {
    ...
    public async duplicate(dto: ProduitDto) {
    ...
    public exportPdf(dto: ProduitDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'categorieProduit?.label', header: 'Categorie produit'},
        ];
    }
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Categorie produit': e.categorieProduit?.label ,
            ...
            //'Categorie produit': this.criteria.categorieProduit?.label ? this.criteria.categorieProduit?.label : environment.emptyForExport ,
    ...
    get selections(): Array<ProduitDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProduitDto>) {
